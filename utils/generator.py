...
def random_Geographical_Location():
    ...
    """国家地理位置"""
    return "内容信息:国家-{0} + 国家编码-{1} + 省-{2} + 市、县-{3} + 区-{4} + 邮编-{5}".format(country,country_code,province,city,district,postcode)
def random_profile():
    """随机个人资料"""
    return fake.profile()
...
if __name__ == '__main__':
    print(random_Geographical_Location())
